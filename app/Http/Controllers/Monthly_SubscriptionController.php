...
class Monthly_SubscriptionController extends AppBaseController
{
    /** @var  UserRepository */
    ...
    public function index(Request $request)
    {
        ...
        return view('monthly_subscriptions.index')->with([
            'roles' => $roles,
        ]);
    }
    ...
    public function create()
    {
        ...
        return view('monthly_subscriptions.create')->with(['roles' => $roles]);
    }
    ...
    public function show(User $user)
    {
        ...
        return view('monthly_subscriptions.show')->with('user', $user);
    }
