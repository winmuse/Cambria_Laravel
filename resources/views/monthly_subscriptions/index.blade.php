@extends('layouts.app')
@section('title')
    {{ __('messages.monthly_subscription_list') }}
@endsection
@section('page_css')
             ...
             <div class="row">
                 <div class="col-lg-12">
                     <div class="card">
                         ...
                         <div class="card-body">
                             @include('monthly_subscriptions.table')
...
@section('scripts')
    <script>
        let createUserUrl = "{{ route('monthly_subscriptions.store') }}";
        let usersUrl = "{{ url('monthly_subscriptions') }}/";
        let defaultImageAvatar = "{{ getDefaultAvatar() }}/";
    </script>
    <script src="{{ mix('assets/js/admin/monthly_subscriptions/monthly_subscriptions.js') }}"></script>
    <script src="{{ mix('assets/js/admin/monthly_subscriptions/edit_user.js') }}"></script>
