            ...
            <div class="modal-body">
                <div class="row col-sm-12">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                {!! Form::text('phone', null, ['class' => 'form-control', 'id' => 'edit_phone']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::email('email', null, ['class' => 'form-control', 'id' => 'edit_email',  'required']) !!}
                        </div>
                            ...
                            <div class="form-group  col-sm-6">
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" id="edit_male" name="gender"
                                            value="{{ \App\Models\User::MALE }}"> <label class="custom-control-label"
                                            for="edit_male">
                                        {{ __('messages.male') }}
                                    </label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" id="edit_female" name="gender"
                                           value="{{ \App\Models\User::FEMALE }}"> <label class="custom-control-label"
                                                                                          for="edit_female">
                                        {{ __('messages.female') }}
                                    </label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('about', null, ['class' => 'form-control user__bio', 'rows' => 3, 'id' => 'edit_about']) !!}
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                {!! Form::select('is_active', [1 => 'Active', 0 => 'In Active'], (isset($user->is_active)) ? $user->is_active : [],  ['class' => 'form-control', 'id' => 'edit_is_active',  'required']) !!}
                            </div>

                            <!-- Role Field -->
                            <div class="form-group col-sm-6">
                                {!! Form::label('role', __('messages.role') ) !!}<span class="red">*</span>
                                {!! Form::select('role_id', $roles, (isset($user->role_id)) ? $user->role_id : [],  ['class' => 'form-control','placeholder' => 'Select Role', 'id' => 'edit_role_id']) !!}
                            </div>
                        </div>
                    ...
                    <div class="text-right form-group col-sm-12">
                        {!! Form::submit(__('messages.save'), ['class' => 'btn btn-primary', 'id' => 'editBtnSave']) !!}
