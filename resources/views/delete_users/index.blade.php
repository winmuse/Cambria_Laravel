...
@section('content')
    ...
    @include('delete_users.create')
    @include('delete_users.edit')
    @include('delete_users.templates.action_icons')
@endsection
@section('page_js')
...
@section('scripts')
    <script>
        let createUserUrl = "{{ route('delete_users.store') }}";
        let usersUrl = "{{ url('delete_users') }}/";
        let defaultImageAvatar = "{{ getDefaultAvatar() }}/";
    </script>
    <script src="{{ mix('assets/js/admin/delete_users/delete_user.js') }}"></script>
    <script src="{{ mix('assets/js/admin/delete_users/edit_user.js') }}"></script>
