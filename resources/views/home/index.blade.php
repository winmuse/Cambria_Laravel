...
@section('content')
    ...
    <section class="section swiper-container swiper-slider swiper-slider-classic" data-loop="true" data-autoplay="5000" data-simulate-touch="true" data-direction="vertical" data-nav="false">
        <div class="swiper-wrapper text-center" >
          <div class="swiper-slide" data-slide-bg="{{asset('assets/images/slider/slider1.jpg')}}">
            <div class="swiper-slide-caption section-md">              
            </div>
          </div>
          <div class="swiper-slide" data-slide-bg="{{asset('assets/images/slider/slider2.jpg')}}">
            <div class="swiper-slide-caption section-md">              
            </div>
          </div>
          <div class="swiper-slide" data-slide-bg="{{asset('assets/images/slider/slider3.jpg')}}">
            <div class="swiper-slide-caption section-md">              
            </div>
          </div>
          <div class="swiper-slide" data-slide-bg="{{asset('assets/images/slider/slider4.jpg')}}">
            <div class="swiper-slide-caption section-md">              
            </div>
          </div>
          <div class="swiper-slide" data-slide-bg="{{asset('assets/images/slider/slider5.jpg')}}">
            <div class="swiper-slide-caption section-md">              
            </div>
          </div>
        </div>
        ...
        <div class="container-fluid creator-view"> 
          ...
          @foreach($user as $data) 
            <div class="col-md-5 col-lg-5 col-xl-4 wow fadeInRight">              
             ...
             <a class="team-classic-figure" href="{{ url('/userprofile/'.$data->id) }}"> 
                <img src="{{$data->photo_url}}" alt="" width="400" height="400"/>
              </a> 
              <script id="tmplUserDetails" type="text/x-jsrender">
              </script>       
                <div class="team-classic-caption">
                  <h4 class="team-classic-name"><a href="{{ url('/userprofile/'.$data->id) }}">{{$data->name}}</a></h4>
                  <p class="team-classic-status">¥{{$data->monthly_price}}/Month</p>
                </div>
              </article>
            </div> 
          @endforeach  
        ...
        <div class="modal-content">
            ...
            <div class="modal-body py-0 hide-scrollbar">
                <div class="row pt-2" data-step="1" data-title="">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                          <img src="{{Auth::user()->photo_url}}" alt="" width="600" height="480"/>
                        </div>
                    </div>
                </div>
            </div>
