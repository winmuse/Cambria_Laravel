<?php $__env->startSection('title'); ?>
    <?php echo e(__('messages.new_register_request_list')); ?>
             ...
             <div class="row">
                 <div class="col-lg-12">
                     <div class="card">
                         ...
                         <div class="card-body">
                             <?php echo $__env->make('new_creators.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        let createUserUrl = "<?php echo e(route('new_creators.store')); ?>";
        let usersUrl = "<?php echo e(url('new_creators')); ?>/";
        let defaultImageAvatar = "<?php echo e(getDefaultAvatar()); ?>/";
    </script>
    <script src="<?php echo e(mix('assets/js/admin/new_creators/new_creators.js')); ?>"></script>
    <script src="<?php echo e(mix('assets/js/admin/new_creators/edit_user.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/custom-datatables.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Cambria\Cambria_Laravel\resources\views/new_creators/index.blade.php ENDPATH**/ ?>