...
<?php $__env->startSection('scripts'); ?>
    <script>
        let createUserUrl = "<?php echo e(route('users.store')); ?>";
        let usersUrl = "<?php echo e(url('users')); ?>/";
        let defaultImageAvatar = "<?php echo e(getDefaultAvatar()); ?>/";
    </script>
    <script src="<?php echo e(mix('assets/js/admin/users/user.js')); ?>"></script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kitc\Documents\tools\Cambria_Laravel-10-27\Cambria_Laravel\resources\views/users/index.blade.php ENDPATH**/ ?>