                ...
                <div class="mb-2 col-sm-12">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="userStatus"
                               placeholder="<?php echo e(__('messages.whats_your_status')); ?>...">
                    </div>
...
</div><?php /**PATH C:\Users\kitc\Documents\tools\Cambria_Laravel-10-27\Cambria_Laravel\resources\views/partials/set_custom_status_modal.blade.php ENDPATH**/ ?>