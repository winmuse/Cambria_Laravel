...
<form method="post" enctype="multipart/form-data" action="<?php echo e(route('update.newpost')); ?>">
<?php echo csrf_field(); ?>
<section class="section section-xl section-fluid"> 
        <div class="container-fluid">         
            <div class="row row-sm  justify-content-center">
                ...
                <?php echo Form::button(__('messages.share') , ['type'=>'submit','class' => 'profile_button','style'=>'width:120px; height:40px; background:#FFDE03','id'=>'btnEditSave']); ?> 
                </div>
              ...
              <div class="blog-post">
                ...
                <div class="form-group bordered-input w-100">
                    ...
                    <input type="text" class="d-none" id="user_id"                          
                           value="<?php echo e(Auth::user()->id); ?>" name="user_id" required>
                </div>
                ...
                <article class="post post-classic">                   
                        ...
                        <!-- <div class="col-4">                             
                            <label class="switch switch-label switch-outline-primary-alt">
                              <p class="text-muted"><?php echo e(__('messages.follow')); ?></p> 
                        ...
                        <div class="col-2" style="margin-top: 20px;">
                          <p class="text-muted"><?php echo e(__('messages.paid_user_only')); ?></p>
                        </div>
                    </div>
...
<?php $__env->startSection('scripts'); ?>
   <!-- Javascript-->
   <script>
        let profileURL ="<?php echo e(route('update.newpost')); ?>"; 
    </script>
    <script src="<?php echo e(asset('assets/js/newpost.js')); ?>"></script>   
    <script src="<?php echo e(asset('assets/js/script.js')); ?>"></script> 
    <script src="<?php echo e(asset('assets/js/upload.js')); ?>"></script> 
    <script src="<?php echo e(asset('assets/js/upload_video.js')); ?>"></script> 
     
<?php $__env->stopSection(); ?>



<?php echo $__env->make('home.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Cambria\Cambria_Laravel\resources\views/home/file_upload.blade.php ENDPATH**/ ?>