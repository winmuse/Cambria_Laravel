<?php $__env->startSection('title'); ?>
    <?php echo e(__('messages.current_creator_list')); ?>
...
<?php $__env->startSection('content'); ?>
             ...
             <div class="row">
                 <div class="col-lg-12">
                     <div class="card">
                         ...
                         <div class="card-body">
                             <?php echo $__env->make('creators.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('creators.templates.action_icons', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        let createUserUrl = "<?php echo e(route('creators.store')); ?>";
        let usersUrl = "<?php echo e(url('creators')); ?>/";
        let defaultImageAvatar = "<?php echo e(getDefaultAvatar()); ?>/";
    </script>
    <script src="<?php echo e(mix('assets/js/admin/creators/creator.js')); ?>"></script>
    <script src="<?php echo e(mix('assets/js/admin/creators/edit_user.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/custom-datatables.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Cambria\Cambria_Laravel\resources\views/creators/index.blade.php ENDPATH**/ ?>