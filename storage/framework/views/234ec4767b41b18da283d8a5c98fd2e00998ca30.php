            ...
            <nav>
                <?php if(auth()->guard()->check()): ?>
                    <?php if(   Auth::user()-> user==1 && Auth::user()-> is_system !=1): ?>
                        <a href="<?php echo e(url('/home')); ?>" class="header__link"><i class="fa fa-home"></i> <?php echo e(__('messages.home')); ?></a>
                        <a href="<?php echo e(url('/conversations')); ?>" class="header__link"><i class="fa fa-comment"></i> <?php echo e(__('messages.chat')); ?></a>
                        <a href="<?php echo e(url('/timeline')); ?>" class="header__link"><i class="fa fa-clock-o"></i> <?php echo e(__('messages.timeline')); ?></a>
                        <a href="<?php echo e(url('/users_profile')); ?>" class="header__link"><i class="fa fa-user"></i> <?php echo e(__('messages.profile')); ?></a>
                        
                    <?php elseif( Auth::user()-> user==2): ?>
                        <a href="<?php echo e(url('/home')); ?>" class="header__link"><i class="fa fa-home"></i> <?php echo e(__('messages.home')); ?></a>
                        <a href="#" data-toggle="modal" data-target="#AlertView" class="header__link"><i class="fa fa-video-camera"></i> <?php echo e(__('messages.live-casting')); ?></a>
                        <a href="<?php echo e(url('/conversations')); ?>" class="header__link"><i class="fa fa-comment"></i> <?php echo e(__('messages.chat')); ?></a>
                        <a href="<?php echo e(url('/file_upload')); ?>" class="header__link"><i class="fa fa-upload"></i> <?php echo e(__('messages.upload')); ?></a>
                        <a href="<?php echo e(url('/timeline')); ?>" class="header__link"><i class="fa fa-clock-o"></i> <?php echo e(__('messages.timeline')); ?></a>
                        <a href="<?php echo e(url('/profile')); ?>" class="header__link"><i class="fa fa-user"></i> <?php echo e(__('messages.profile')); ?></a>
                    <?php elseif( Auth::user()-> user==1 && Auth::user()-> is_system==1): ?>
                        <a href="<?php echo e(url('/home')); ?>" class="header__link"><i class="fa fa-home"></i> <?php echo e(__('messages.home')); ?></a>
                        <a href="<?php echo e(url('/conversations')); ?>" class="header__link"><i class="fa fa-comment"></i> <?php echo e(__('messages.chat')); ?></a>
                        <a href="<?php echo e(url('/timeline')); ?>" class="header__link"><i class="fa fa-clock-o"></i> <?php echo e(__('messages.timeline')); ?></a>
                        <a href="<?php echo e(url('/users_profile')); ?>" class="header__link"><i class="fa fa-user"></i> <?php echo e(__('messages.profile')); ?></a>
                        <a href="<?php echo e(url('/settings')); ?>" class="header__link"><i class="fa fa-user"></i> <?php echo e(__('messages.adminpanel')); ?></a>
                    <?php endif; ?>
                <?php else: ?>
                    <?php if(Route::has('login')): ?>
                        <a href="<?php echo e(route('login')); ?>" class="header__link"><?php echo e(__('messages.login')); ?></a>
                    <?php endif; ?>
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="header__link"><?php echo e(__('messages.register')); ?></a>
                    <?php endif; ?>
                <?php endif; ?>
            </nav>
    </div>
...
<?php /**PATH C:\Users\kitc\Documents\tools\Cambria_Laravel-10-27\Cambria_Laravel\resources\views/home/app.blade.php ENDPATH**/ ?>