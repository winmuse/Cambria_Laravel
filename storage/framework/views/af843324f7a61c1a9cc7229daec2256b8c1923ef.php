                                ...
                                <div class="row">
                                    <div class="col-12  text-center">
                                        <button class="btn button button-primary button-pipaluk button-circle mt-2" type="button"
                                                id="loginBtn"><?php echo e(__('messages.login')); ?></button>
                                    </div>                                                                    
                                </div>
                                
                                <div class="row">
                                    <div class="col-12 text-center">
                                        <a class="btn button button-primary button-pipaluk button-circle mt-2"  href="<?php echo e(url('/register')); ?>"><?php echo e(__('messages.register_now!')); ?></a>
                                    </div>
                                </div>
                                </form>
...
<?php echo $__env->make('layouts.auth_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kitc\Documents\tools\Cambria_Laravel-10-27\Cambria_Laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>