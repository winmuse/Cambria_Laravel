...
<div id="deletePost" class="modal fade" role="dialog" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo e(__('messages.delete_the_post')); ?></h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <?php echo Form::open(['id'=>'deletePostForm']); ?>
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-sm-12">
                    <?php echo Form::label('password', __('messages.delete_post_message')); ?>

                </div>
                <div class="text-right form-group col-sm-12">
                    <?php echo Form::button(__('messages.delete'), ['type'=>'submit','class' => 'btn button button-primary button-pipaluk button-circle mt-2','id'=>'btnDeleteSave','data-loading-text'=>"<i class='fa fa-refresh fa-spin'></i> " .__('messages.processing')]); ?>
...
</div><?php /**PATH D:\Cambria\Cambria_Laravel\resources\views/layouts/change_password.blade.php ENDPATH**/ ?>